...
const handleLogin = async (e) => {
  ...
  try {
    ...
    // Save token or handle login success (e.g., redirect user)
    ...
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          ...
          <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal">Enter your username or email and password to Sign In.</Typography>
        </div>
        ...
        <form onSubmit={handleLogin} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <Button type="submit" onClick={handleLogin} className="mt-6" fullWidth>
